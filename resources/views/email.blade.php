        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
          <section class="ftco-section">
            ...
            <h3 style="" class="heading-section">motif:</h3>
              <p class="word">{{$liste->motif }}</p>
            <h3 style="" class="heading-section">conclusion:</h3>
              <p class="word"> {{$liste->espace_conclusion }} </p>
            
            <h2 style="text-decoration: underline" class="heading-section">Prochaine convocation:</h2> 
            <h4 style="font-style: bold" class="heading-section">Date: 20/07/2022</h4>
              
            <h4 style="font-style: bold" class="heading-section">heure: 10:20:00</h4>
              
            <h4 style="font-style: bold" class="heading-section">salle:  salle3</h4>
              
            <h4 style="text-decoration: underline" class="heading-section">motif de la convocation:</h4>
            <p class="word"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ornare maximus vehicula. Duis nisi velit, dictum id mauris vitae, lobortis pretium quam. Quisque sed nisi pulvinar, consequat justo id, feugiat leo. Cras eu elementum dui.</p>
          </section>
      @endforeach      
        </div>
    </body>
